...
# Fit data with mortality function 'Bathtub function' (4th order polinomial)
...
dataset = odr.RealData(x, y, sx=err_x, sy=err_y)
    ...
    # Set ODR with data and model - Change the values into beta0 to change the initial conditions for the fitting
...
# Upper ad lower confidence bands
    ...
    # Create the linespace to plot the best fit curve - Change the first two values to change the plot range!
...
print('\n Bathtub function (a * x^4 + b * x^3 + c * x^2 + d * x + e) fit results: \n')
